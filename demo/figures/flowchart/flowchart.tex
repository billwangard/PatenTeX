...
\draw(49,30) node[anchor=center]{\flab{fl:box}};
...
\draw(26.00,41.00) node[anchor=base west]{\alab{fl:input}};
\path[line width=0.30mm, draw=L] (41.00,25.00) -- (50.00,15.00);
\draw(50.00,14.00) node[anchor=base west]{\alab{fl:processor}};
\path[line width=0.30mm, draw=L] (85.00,20.00) -- (82.00,25.00);
\draw(85.00,19.00) node[anchor=base west]{\alab{fl:output}};
\end{tikzpicture}%
